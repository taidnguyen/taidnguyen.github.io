...
ax.plot(sx, sy, "-o", color=SELF, lw=2, ms=5, label="self (model grades itself)")
...
ax.text(0.02, 0.97, "self-grading run  ·  oracle sits at gold 1.0, collusion 0",
        transform=ax.transAxes, fontsize=8.5, color="#999", va="top")
fig.tight_layout()
